...
PRODUCT_VENDOR_PROPERTIES += \
    ...
    persist.log.tag.SystemServerTiming=S \
    persist.log.tag.SystemServerTimingAsync=S \
    persist.log.tag.libprocessgroup=S \
    persist.log.tag.HfLooper=S \
    persist.log.tag.SensorService=S \
    persist.log.tag.libbinder.BackendUnifiedServiceManager=S \
    persist.log.tag.mt6360_pmu_chg=S \
    persist.log.tag.[tran_touch-INFO]ps_sample=S \
    persist.log.tag.MediaCodecsXmlParser=S \
    persist.log.tag.TRS=S \
    persist.log.tag.AudioParamParser-vnd=S \
    persist.log.tag.tran_charger_control_check=S \
    persist.log.tag.[GF_HAL][gf_hal_milan]=S
